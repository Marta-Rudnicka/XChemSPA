...
export class ChevronUp extends Component {
	render() {
		 return (
			<svg xmlns="http://www.w3.org/2000/svg"  width={this.props.size} height={this.props.size} onClick={() => this.props.handleClick()} fill="currentColor" className="bi bi-chevron-up" viewBox="0 0 16 16">
...
export class Bin extends Component {
	render() {
		return (
			<svg xmlns="http://www.w3.org/2000/svg" width={this.props.size} height={this.props.size} onClick={() => this.props.handleClick(this.props.args)} fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
...
export class Recycle extends Component {
	render(){
		return (
		<svg xmlns="http://www.w3.org/2000/svg" width={this.props.size} height={this.props.size} onClick={() => this.props.handleClick(this.props.args)} fill="currentColor" className="bi bi-recycle" viewBox="0 0 16 16">
...
export class InfoCircle extends Component {
	render(){
		return (
		<svg xmlns="http://www.w3.org/2000/svg"  width={this.props.size} height={this.props.size} onClick={() => this.props.handleClick()} fill="currentColor" className="bi bi-info-circle" viewBox="0 0 16 16">
